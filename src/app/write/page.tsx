      ...
      <header className="flex-shrink-0 flex items-center justify-between px-5 md:px-8 py-3 md:py-4 border-b border-deep-blue/[0.06]">
        ...
        <div className="flex items-center gap-4">
          ...
          {!error && !isSubmitting && streak && streak.streak > 1 && (
            <div
              aria-label={`${streak.streak}-day streak${streak.certifiedToday ? '' : '. Finish today to keep it going.'}`}
              className="flex items-center gap-2 px-3 py-1.5 bg-white border border-deep-blue/[0.08] rounded-full"
            >
              ...
              <span className="text-xs text-deep-blue/60">
                ...
                {!streak.certifiedToday && (
                  <span className="hidden md:inline"> · finish today</span>
                )}
              </span>
            </div>
          )}
