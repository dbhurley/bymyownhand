  ...
  return (
    <>
      ...
      <main style={{ maxWidth: "660px", margin: "0 auto", padding: "0 24px 64px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px", fontSize: "0.82rem", color: "#6b7280", flexWrap: "wrap" }}>
          {post.tags.slice(0, 3).map((tag) => (
            <span key={tag} style={{ padding: "2px 8px", borderRadius: "6px", background: "#2563eb18", color: "#2563eb", fontWeight: 600, fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.04em" }}>{tag}</span>
          ))}
          <span>{post.date}</span>
